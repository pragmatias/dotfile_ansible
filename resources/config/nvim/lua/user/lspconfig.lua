...
function M.config()
  ...
  wk.register {
    ...
    ["<leader>ll"] = { "<cmd>lua vim.lsp.codelens.run()<cr>", "CodeLens Run" },
    ["<leader>lq"] = { "<cmd>lua vim.diagnostic.setloclist()<cr>", "Quickfix" },
    ["<leader>lr"] = { "<cmd>lua vim.lsp.buf.rename()<cr>", "Rename" },
    -- Metals
    ["<leader>mw"] = { "<cmd>lua require 'metals'.hover_worksheet()<cr>", "Metals hover_worksheet"},
    -- tree view
    ["<leader>mtt"] = { "<cmd>lua require 'metals.tvp'.toggle_tree_view()<cr>", "Metals tvp tree view"},
    ["<leader>mtr"] = { "<cmd>lua require 'metals.tvp'.reveal_in_tree()<cr>", "Metals reveal tree"},
    -- all workspace diagnostics
    ["<leader>xa"] = { "<cmd>lua vim.diagnostic.setqflist()<cr>" , "Diagnostic All" },
    -- all workspace errors
    ["<leader>xe"] = { "<cmd>lua vim.diagnostic.setqflist({ severity = 'E' })<cr>", "Diagnostic Err" },
    -- all workspace warnings
    ["<leader>xw"] = { "<cmd>lua vim.diagnostic.setqflist({ severity = 'W' })<cr>", "Diagnostic Warn" },
    -- buffer diagnostics only
    ["<leader>xd"] = { "<cmd>lua vim.diagnostic.setloclist()<cr>", "Diagnostic" },
  }
  ...
  -- LSP Config for Scala with nvim-metals
  ...
  metals_config.capabilities = M.common_capabilities()
